...
namespace BlackSlope.Services.Movies
{
    public class MovieService : IMovieService
    {
        ...
        public Task<bool> CheckIfMovieExistsAsync(string title, DateTime? releaseDate)
        {
            throw new NotImplementedException();
        }

        public Task<MovieDomainModel> CreateMovieAsync(MovieDomainModel movie)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<IEnumerable<MovieDomainModel>> GetAllMoviesAsync()
        {
            throw new NotImplementedException();
        }

        public Task<MovieDomainModel> GetMovieAsync(int id)
        {
            throw new NotImplementedException();
        }

        public Task<MovieDomainModel> UpdateMovieAsync(MovieDomainModel movie)
        {
            throw new NotImplementedException();
        }
    }
